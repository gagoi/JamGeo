...
public Field[] fieldsList = {
    new Field(43, "T1", 4, (Equipement)magicCardsList[E_THORN_2], Type.SEDIMENTAIRE), //Bonus Sedimentaire
    new Field(44, "T2", 5, (Equipement)magicCardsList[E_MULTIPLE_2], Type.MAGMATIQUE), //Bonus Magmatique
    new Field(45, "T3", 5, (Equipement)magicCardsList[E_SHIELD_2], Type.METAMORPHIQUE), //Bonus metamorphique
    new Field(46, "T4", 4, malusSed, Type.SEDIMENTAIRE), //Malus Sedimentaire
    new Field(47, "T5", 5, malusMag, Type.MAGMATIQUE), //Malus Magmatique
    new Field(48, "T6", 5, malusMet, Type.METAMORPHIQUE), //Malus metamorphique
};
//30 cartes a faire
